...
%>
<%
    data=(Cliente) request.getAttribute("datos");
...
<section class="full-width pageContent ">
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form class="contact100-form validate-form" action="ClienteControl?valor=EditGuardar&id=<%=data.getId()%>" method="post"
                  >
                    <span class="contact100-form-title">
                        EDITAR CLIENTE <i class="fas fa-user"></i>
                    </span>
                <div class="wrap-input100 validate-input">


                    <div class="wrap-input100 validate-input">
                        <label class="label-input100" for="nombres">Nombres:</label>
                        <input class="input100" type="text" name="nombres" required="true" id="nombres" value="<%=data.getNombres()%>">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input">
                        <label class="label-input100" for="apellidos">Apellidos:</label>
                        <input class="input100" type="text" name="apellidos" required="true" id="apellidos"  value="<%=data.getApellidos()%>">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input">
                        <label class="label-input100" for="dni">Dni:</label>
                        <input class="input100" type="text" name="dni" id="dni" required="true" value="<%=data.getDni()%>">
                        <span class="focus-input100"></span>
                    </div>
                      <div class="wrap-input100 validate-input">
                        <label class="label-input100" for="telefono">Telefono:</label>
                        <input class="input100" type="text" name="telefono"  required="true" id="telefono" value="<%=data.getTelefono() %>">
                        <span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="container-contact100-form-btn">
                        <div class="wrap-contact100-form-btn">
                            ...
                            <button class="contact100-form-btn" type="submit" id="btnGuardar">
                                Submit
